    ...
    */
    public void setup() {
        ...
        try {
            ...
            this.brickwallDestruction[1] = loadImage(this.getClass().getResource("brickwall_destroyed0.png").getPath().replace("%20", " "));
            this.brickwallDestruction[2] = loadImage(this.getClass().getResource("brickwall_destroyed0.png").getPath().replace("%20", " "));
            this.brickwallDestruction[3] = loadImage(this.getClass().getResource("brickwall_destroyed0.png").getPath().replace("%20", " "));
        ...
        for (Character[] j : mapContents){
                ...
                for(Character k :j){
                    ...
                    else if (k =='B'){ // ! Brick ... TO CHANGE LATER
                        mapToDraw.add(new Destructable(xCounter, yCounter, this.brickwall, wizardSprites)); 
                    }
