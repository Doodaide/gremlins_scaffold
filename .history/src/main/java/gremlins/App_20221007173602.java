    ...
    */
    ...
    private void powerUpSpawn(int seconds){
        ...
        if(p != null){
            ...
            if(p.getConsumed() && this.innateCooldown == 10*FPS){
                ...
                this.innateCooldown -= FPS;
            }

            else if (p.getConsumed() && p.getCooldown() < 10*FPS){
                p.setCooldown(p.getCooldown() + 1);
                System.out.println(p.getCooldown());
            }

            else if(p.getCooldown() == 10*FPS){
