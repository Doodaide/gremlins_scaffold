...
public class App extends PApplet {
    ...
    private PImage[] brickwallDestruction; // set of images of the brick wall in the process of 'destructing'
    ...
    */
    ...
    private int[] respawnMechanics(){ // generates a set of free coordinates 10 blocks away from the player
        int wX = w.getX(); 
        int wY = w.getY();
        while (wX % 20 != 0){
            wX += 1;
    ...
    private void powerUpSpawn(int seconds){
        if(seconds > 3){
            if(!powerUpSpawned && this.innateCooldown == 0){
        ...
        if(p != null){
            ...
            if(this.innateCooldown == 0){
                ...
                System.out.println("potion has been consumed in app");
    ...
    public void draw() {
        ...
        if(!won){
            ...
            if(p != null){
                ...
                System.out.println("consumed: " + p.getConsumed());
                System.out.println("Powerup Spawned: " + this.powerUpSpawned);
                System.out.println("Cooldown" + p.getCooldown());
                System.out.println("Active " + this.getFreezeActive());
                
                if(!this.powerUpSpawned && p.getConsumed() && this,getFreezeActive){
                    System.out.println("past assessing");
                    ...
                    else if (p.getCooldown() < 5*FPS && this.getFreezeActive()){
