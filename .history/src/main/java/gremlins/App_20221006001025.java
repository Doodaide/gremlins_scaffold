...
public class App extends PApplet {
    ...
    */
    ...
    private void powerUpSpawn(int seconds){
        ...
        if(p != null){
            if(!p.getConsumed()){
                ...
                System.out.println("potion drawn");
            }

            else if(p.getConsumed()){
                System.out.println("potion has been consumed in app");
                System.out.println("p before " + mapToDraw.indexOf(p));
                mapToDraw.set(mapToDraw.indexOf(p), null);
                System.out.println("p after" + mapToDraw.get());
    ...
    public void draw() {
        ...
        System.out.println(mapToDraw.contains(p));
        ...
        if(this.lives <= 0){
            ...
            won = true;
            return; // replace with waitScreen
        }
