...
public class DrawMap {
     ...
     * @param app the App class that contains the ArrayLists that contain all the objects. 
     */
    ...
    /**
     * A getter method that gets the wizard's starting coordinates in the form of an integer array 
     * @return an integer array in the form [x coordinate, y coordinate]
     */
