    ...
    public int tick(App app) {
        ...
        if(wDir == 0 && wX%20==0 && wY%20==0){
            ...
            for (int i = wY; i > app.upperBound; i -= 20){
                ...
                for(Mobile M : app.getMobiles()){
                    if(M != null){
                        if(M.getX() == wX && M.getY() < wY && !this.toKill.contains(M) 
                        && M.getClass().getName().equals("gremlins.Gremlin")){
                            System.out.println("Gremlin destroyed");
                        }
                    }
                }
            }
            ...
            for (int i = wX; i < app.rightBound; i += 20){
                ...
                for(Mobile M : app.getMobiles()){
                    if(M != null){
                        if(M.getY() == wY && M.getX() > wX && !this.toKill.contains(M) 
                        && M.getClass().getName().equals("gremlins.Gremlin")){
                            System.out.println("Gremlin destroyed");
                        }
                    }
                ...
                //System.out.println("Broken right" + (i - wX));
            ...
            for (int i = wX; i > app.leftBound; i -= 20){
                ...
                for(Mobile M : app.getMobiles()){
                    if(M != null){
                        if(M.getY() == wY && M.get/x() < wY && !this.toKill.contains(M) 
                        && M.getClass().getName().equals("gremlins.Gremlin")){
                            System.out.println("Gremlin destroyed");
                        }
                    }
