    ...
    */
    ...
    public void draw() {
        ...
        */
        ...
        UpdateArrayList<Mobile> updater3 = new UpdateArrayList<Mobile>();
        this.NPMobileEntities = updater3.update(this.NPMobileEntities);
        updater3 = null;
        ArrayList<Mobile> temp2 = new ArrayList<Mobile>();
        for (Mobile entity : this.NPMobileEntities) {
            if(!entity.getClass().getName().equals("gremlins.Fireball") && !entity.getClass().getName().equals("gremlins.Gremlin") && !!entity.getClass().getName().equals("gremlins.Gremlin")){
                temp2.add(entity);
            }
        }
