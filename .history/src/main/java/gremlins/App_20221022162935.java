    ...
    public void draw() {
            if(!won){
                if(!instructionsUp){
                    ...
                    textSize(15);
                    text("|h for help|", 145, App.HEIGHT - 35);
                    fill(255, 255, 255);
                    lvlMessage = null;
                    if(p != null){
                    ...
                    text("Use arrow keys to move, shoot fireballs with space", 20, 130); 
                    ...
                    text("Be wary, frozen slime is harmless. You can't fireball it", 10, 290); 
                    text("Frozen gremlins still hurt though", 40, 330);
                    text("Press k for a powerful yet weak beam", 20, 370);
                    text("t is for teleport, but be warned, it's not always safe", 5, 410);
                    text("The bars at the bottom provided useful information", 15, 440);
                    text("Don't lose :)", 120, 520);
                    fill(49,90,180);
                    return;
                }
            }
