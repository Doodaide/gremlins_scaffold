    ...
    */
    public void setup() {
        ...
        if(won && !passedLvl2){
            ...
            double enemyCooldown = level2.getDouble("wizard_cooldown") * FPS;
            double wizardCooldown = level2.getDouble("enemy_cooldown") * FPS;
            passedLvl2 = true;
        }
        else{
            JSONObject level1 = levelSpecs.getJSONObject(0);
            layout = level1.getString("layout");
            double enemyCooldown = level1.getDouble("wizard_cooldown") * FPS;
            double wizardCooldown = level1.getDouble("enemy_cooldown") * FPS;
        }
