...
public abstract class Mobile extends Entity{
    ...
    public int collision(App app) {
        ...
        if(collides(this.x, this.y - 1, app) || 
            collides(this.x+this.WIDTH, this.y - 1, app)){ // top left corner, hit up
            upAV = false;
            System.out.println("Up side");
        }

        else if(!collides(this.x + 1, this.y - 1, app) && !collides(this.x+this.WIDTH, this.y - 1, app)){ // top left corner, hit up
            upAV = true;
