...
public abstract class Mobile extends Entity{
    ...
    public int collision(App app) { // mob to block collision 
        ...
        else if(!collides(this.x+this.WIDTH + 2, this.y + 2, app) &&
            !collides(this.x + this.WIDTH + 2, this.y + this.HEIGHT - 2, app)){// Top right corner, hit right 
            rightAV = true;
            toReturn = 0;
        ...
        if(collides(this.x + 2, this.y + this.HEIGHT + 2, app) || // Bottom left corner, hit down
            collides(this.x + this.WIDTH - 2, this.y + this.HEIGHT + 2, app)){ // Bottom right corner, hit down
            downAV = false;
            toReturn = 1;
            //System.out.println("Bottom side");
        }

        else if(!collides(this.x + 2, this.y + this.HEIGHT + 2, app) && 
            !collides(this.x + this.WIDTH - 2, this.y + this.HEIGHT + 2, app)){// Bottom left corner, hit down
            downAV = true;
            toReturn = 0;
