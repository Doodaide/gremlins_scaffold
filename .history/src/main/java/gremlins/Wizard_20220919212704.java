...
public class Wizard extends Mobile{
     ...
     * 
     */
    private int xNewPosition, yNewPosition;
    ...
    public Wizard(int x, int y, int speed, PImage imgUp, 
        ...
        this.xDir = 3;
        this.yDir = 0;
        this.xNewPosition = App.wizStartX;
        this.yNewPosition = 0;
    ...
    public int draw(App app){
        ...
        //this.x += this.xVel;
        //this.y += this.yVel;
        this.x = this.xNewPosition;
        this.y = this.yNewPosition;
