...
public abstract class Mobile extends Entity{
    ...
    public int collision(App app) { // mob to block collision 
        ...
        if(collides(this.x + 2, this.y + this.HEIGHT + 1, app) || // Bottom left corner, hit down
            collides(this.x + this.WIDTH - 2, this.y + this.HEIGHT + 1, app)){ // Bottom right corner, hit down
            downAV = false;
            toReturn = 1;
            //System.out.println("Bottom side");
        }

        else if(!collides(this.x + 2, this.y + this.HEIGHT + 1, app) && 
            !collides(this.x + this.WIDTH - 2, this.y + this.HEIGHT + 1, app)){// Bottom left corner, hit down
            downAV = true;
            toReturn = 0;
