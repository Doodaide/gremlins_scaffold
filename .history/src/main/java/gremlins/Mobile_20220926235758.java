...
public abstract class Mobile extends Entity{
    ...
    private Mobile collisionEntity;
    ...
    public boolean collides(int xCoord, int yCoord, App app) {
        ...
        for(Mobile i : app.NPMobileEntities){
            if(this != i && (!this.getClass().getName().equals("gremlins.Wizard") || !i.getClass().getName().equals("gremlins.Fireball")) 
            && (!this.getClass().getName().equals("gremlins.Gremlin") || !i.getClass().getName().equals("gremlins.Slimeball"))){
