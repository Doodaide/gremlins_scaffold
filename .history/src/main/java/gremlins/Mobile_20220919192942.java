...
public abstract class Mobile extends Entity{
    ...
    public int collision(App app) {
        ...
        if(collides(this.x + 1, this.y + this.HEIGHT + 1, app) || // Bottom left corner, hit down
            collides(this.x + this.WIDTH - 1, this.y + this.HEIGHT + 1, app)){ // Bottom right corner, hit down
            downAV = false;
            System.out.println("Bottom side");
        }

        else if(!collides(this.x + 1, this.y + this.HEIGHT + 1, app) && 
            !collides(this.x + this.WIDTH - 1, this.y + this.HEIGHT + 1, app)){// Bottom left corner, hit down
            downAV = true;
