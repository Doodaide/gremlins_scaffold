...
public abstract class Mobile extends Entity{
    ...
    public int collision(App app) { // mob to block collision 
        ...
        if(collides(this.getX() + 2, this.getY() + this.HEIGHT - 1, app) || // Bottom left corner, hit down
            collides(this.getX() + this.WIDTH - 2, this.getY() + this.HEIGHT - 1, app)){ // Bottom right corner, hit down
            downAV = false;
            toReturn = 1;
        ...
        else if(!collides(this.getX() + 2, this.getY() + this.HEIGHT - 1, app) && 
            !collides(this.getX() + this.WIDTH - 2, this.getY() + this.HEIGHT - 2, app)){// Bottom left corner, hit down
            downAV = true;
            toReturn = 0;
