...
public class App extends PApplet {
    ...
    */
    public void setup() {
        ...
        this.stonewall 
        = loadImage(this.getClass().getResource("stonewall.png").getPath().replace("%20", " "));
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ArrayList<Indestructable> border = new ArrayList<Indestructable>();
            for (Character[] j : mapContents){
                for(Character k :j){
                    if(k == 'X'){
                        // stone block
                        border.add(new Indestructable(x, y, this.stonewall));
