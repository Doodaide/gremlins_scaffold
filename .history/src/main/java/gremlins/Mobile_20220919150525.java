...
public abstract class Mobile extends Entity{
    ...
    public int collision(App app) {
        ...
        if(!collides(this.x, this.y, app)// top left corner
            ||
            !collides(this.x , this.y+this.HEIGHT, app) // bottom left corner 
            ){
        ...
        if(collides(this.x , this.y+this.HEIGHT, app) // bottom left corner 
            &&
