...
public class App extends PApplet {
    ...
    */
    public void keyPressed(KeyEvent e){
        ...
        /*
         * if((key == 37 && w.yDir == 0) || (w.xDir == 3 && key == 38) ||// left up
            (key == 39 && w.yDir == 0) || (w.xDir == 1 && key == 38) ||// right up
            (key == 39 && w.yDir == 2) || (w.xDir == 1 && key == 40) ||// right down
            (key == 37 && w.yDir == 2) || (w.xDir == 3 && key == 40)// left down
            ){
                System.out.println("Found you");
            }
         */
        if((key == 37 && w.yDir != w.direction) || 
            (w.xDir == 3 && key == 38) ||// left up
            (key == 39 && w.yDir != w.direction) || 
            (w.xDir == 1 && key == 38) ||// right up
            (key == 39 && w.yDir == 2) || 
            (w.xDir == 1 && key == 40) ||// right down
            (key == 37 && w.yDir == 2) || 
            (w.xDir == 3 && key == 40)// left down
            ){
                System.out.println("Found you");
            }

        else if(key == 37 && w.leftAV){ //left arrow 
            w.left();
            //System.out.println("left");
        }
        else if (key == 39 && w.rightAV){ //right arrow 
            w.right();
            //System.out.println("right");
        }
        else if (key == 38 && w.upAV){ //up arrow 
            w.up();
            //System.out.println("up");
        }
        else if (key == 40 && w.downAV){ //down arrow
            w.down();
