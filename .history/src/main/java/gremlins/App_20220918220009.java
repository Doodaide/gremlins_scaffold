    ...
    */
    public void setup() {
        ...
        try {
            ...
            wizardSprites[4] = loadImage(URLDecoder.decode(this.getClass().getResource("fireball.png").getPath(), StandardCharsets.UTF_8.toString()))
            w = new Wizard(20, 20, 2, wizardSprites[0], wizardSprites[1], wizardSprites[2], wizardSprites[3], 
            );
