...
public abstract class Mobile extends Entity{
    ...
    public int collision(App app) { // mob to block collision 
        ...
        if(collides(this.x + 1, this.y + this.HEIGHT, app) || // Bottom left corner, hit down
            collides(this.x + this.WIDTH , this.y + this.HEIGHT, app)){ // Bottom right corner, hit down
            downAV = false;
            toReturn = 1;
            ...
            !collides(this.x + this.WIDTH, this.y + this.HEIGHT, app)){// Bottom left corner, hit down
            downAV = true;
            toReturn = 0;
