...
public abstract class Mobile extends Entity{
    ...
    public boolean collides(int xCoord, int yCoord, App app) {
        ...
        for(Mobile i : app.NPMobileEntities){
            if(this != i && (!this.getClass().equals("gremlins.Wizard") || !i.getClass().equals("gremlins.Fireball")) && (!this.getClass().equals("gremlins.Wizard") || !i.getClass().equals("gremlins.Fireball"))){
