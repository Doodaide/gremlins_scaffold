...
public class JSONReader extends PApplet{
    ...
    /**
     * getter method for the level Specs (a hashmap<String, Double>)
     * @return Hashmap<String, Double> that contains the level file contents. 
     */
     ...
     * @throws Exception Runtime exception expected if the index or any 
     */
