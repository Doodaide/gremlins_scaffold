...
public abstract class Immobile extends Entity{
     ...
     * @return true or false, depending on whether the wizard, gremlins, projectiles can interact with it
     */
    public abstract boolean getViable();

    /**
     * Abstract set viable method sets whether the block is interactable anymore 
     * @param b 
     */
