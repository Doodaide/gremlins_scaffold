...
public class App extends PApplet {
    ...
    */
    public void setup() {
        ...
        JSONArray level1 = levelSpecs.getJSONArray(0)
        String layout = levelSpecs.getString(0);
        int enemyCooldown = levelSpecs.getInt(1);
        int wizardCooldown = levelSpecs.getInt(2);
