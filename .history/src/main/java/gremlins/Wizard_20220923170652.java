...
public class Wizard extends Mobile{
    ...
    public int draw(App app){
        ...
        if(!this.leftAV && (this.xVel < 0) && this.direction != 1){
            this.xStop();
            this.xVel = 0;
        }

        if(!this.rightAV && (this.xVel > 0) && this.direction != 3){
            this.xStop();
            this.xVel = 0;
        }

        if(!this.upAV &&(this.yVel < 0) && this.direction 1= 2){
            this.yStop();
            this.yVel = 0;
        }

        if(!this.downAV && (this.yVel > 0) && this.direction == 0){
            this.yStop();
            this.yVel = 0;
        }
