    ...
    public void keyPressed(KeyEvent e){
        ...
        if(key == 37){ //left arrow 
            ...
            for (Immobile i : mapToDraw) { // i = block
                ...
                if (i.getClass().toString().equals("Destructable")){
                    System.out.println("Bruh destroyed");
                }
        ...
        if(f != null){
            ...
            if(collided == 1){ // fireball hit something
                for (Immobile i : mapToDraw) { // i = block
                    ...
                    ||
                    (collides(this.x + 1, this.y - 1, app) || 
                    collides(this.x+this.WIDTH - 1, this.y - 1, app)
                    )
                    ||
