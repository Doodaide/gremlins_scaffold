...
public class App extends PApplet {
    ...
    */
     ...
     * Many objects are instantiated within other helper classes such as DrawMap that produces a something readable file from the 
     * this class such as the wizard. 
    */
    public void setup() {
        frameRate(FPS);
        this.seconds = 0;
