    ...
    */
    public void setup() {
        ...
        try {
            ...
            this.hBeam = loadImage(this.getClass().getResource("wizardTP.png").getPath().replace("%20", " "));
            this.sBeam = loadImage(this.getClass().getResource("wizardTP.png").getPath().replace("%20", " "));
    ...
    */
    public void keyPressed(KeyEvent e){
        ...
        if (key == 32){ //space
            ...
            k = new Kamehameha(w.getX(), w.getY(), this.frozenG);
        }
    }
