...
public class App extends PApplet {
    ...
    // private int properX, properY; // ! to delete
    ...
    */
    ...
    public void fireballMechanics(){
        for(Fireball f: w.getExistingFireballs()){ // checks through every fireball
            ...
            if(f!= null){
                ...
                if((collided == 1 || f.getDecaying()) && f.getCollisionEntity() == null){ 
                    ...
                    if(f.getFrameCounter() == 16){ // always check if it's the end of the sequence 
                        ...
                        w.getExistingFireballs().set(w.getExistingFireballs().indexOf(f), null);
                        f = null;
    ...
    public void powerUpSpawn(int seconds){
        if(seconds > 10){
            System.out.println("Powerup can spawn");
        }
    }
