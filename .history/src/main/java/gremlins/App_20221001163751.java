...
public class App extends PApplet {
    ...
    */
    public void setup() {
        ...
        if(won){
            ...
            String layout = level2.getString("layout");
            int enemyCooldown = level2.getInt("wizard_cooldown");
            int wizardCooldown = level2.getInt("enemy_cooldown");
        }
        else{
            JSONObject level1 = levelSpecs.getJSONObject(0);
            String layout = level1.getString("layout");
            int enemyCooldown = level1.getInt("wizard_cooldown");
            int wizardCooldown = level1.getInt("enemy_cooldown");
        }
    ...
    */
    ...
    public int theGremlinAI(int dir, Gremlin g){
        /*
    ...
    public void draw() {
        ...
        if(gArray.size() == 0){ // Win condition 
