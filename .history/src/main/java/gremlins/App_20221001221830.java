...
public class App extends PApplet {
    ...
    */
    ...
    public void draw() {
        ...
        textSize(20);
        text(this.livesToDraw , 20, HEIGHT - 25);
        fill(255, 255, 255);
        if(w.tick(this) == 10){
            this.livesToDraw -= 1;
            this.setup();
        ...
        if(gArray.size() == 0 && passedLvl2){ // Win condition (pass lvl 1)
        ...
        else if(gArray.size() == 0){  // win condition (pass lvl 2)
