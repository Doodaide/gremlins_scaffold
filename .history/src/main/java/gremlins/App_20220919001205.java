...
public class App extends PApplet {
    ...
    */
    public void keyPressed(KeyEvent e){
        ...
        if(key == 37 && !w.collides(w.getX()-1, w.getY(), this)){ //left arrow 
            w.left();
            System.out.println("left");
        }
        else if (key == 39 && !w.collides(w.getX()+w.WIDTH+1, w.getY(), this)){ //right arrow 
            w.right();
            System.out.println("right");
        }
        else if (key == 38 && !w.collides(w.getX(), w.getY()+1, this)){ //up arrow 
            w.up();
            System.out.println("up");
        }
        else if (key == 40 && !w.collides(w.getX(), w.getY()+w.HEIGHT+1, this)){ //down arrow
            w.down();
