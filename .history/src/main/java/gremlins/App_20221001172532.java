...
public class App extends PApplet {
    ...
    */
    public void setup() {
        ...
        if(won && !passedLvl2){
            ...
            this.layout = level2.getString("layout");
            this.enemyCooldown = level2.getDouble("wizard_cooldown") * FPS;
            this.wizardCooldown = level2.getDouble("enemy_cooldown") * FPS;
            passedLvl2 = true;
        }
        else{
            JSONObject level1 = levelSpecs.getJSONObject(0);
            this.layout = level1.getString("layout");
            this.enemyCooldown = level1.getDouble("wizard_cooldown") * FPS;
            this.wizardCooldown = level1.getDouble("enemy_cooldown") * FPS;
        }
    ...
    */
    public void keyPressed(KeyEvent e){
        ...
        if (key == 32){ //space
            if((w.getX() % 20 == 0 || w.getY() % 20 == 0) && w.getManaCoolDown()>=wizardCooldown){
    ...
    */
    ...
    public void draw() {
        ...
        else if(gArray.size() == 0){ // Win condition 
