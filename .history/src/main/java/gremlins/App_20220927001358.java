    ...
    */
    ...
    public void fireballMechanics(){
        for(Fireball f: existingFireballs){ // checks through every fireball
            ...
            if(f!= null){
                ...
                System.out.println("Entity hit "+f.collisionEntity);
                if((collided == 1 || f.getDecaying()) && f.collisionEntity == null){ 
    ...
    public void draw() {
        ...
        */
        ...
        temp = null;
        ArrayList<Entity> temp = new ArrayList<Fireball>();
        for (Entity entity : this.NPMobileEntities) {
            if(entity.getClass().getName().equals("gremlins.Fireball")){
