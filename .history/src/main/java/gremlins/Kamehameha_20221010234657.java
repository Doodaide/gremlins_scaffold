    ...
    public int draw(App app) {
        if(this.direction == 0){ // up or down 
            for(int i = 0; i < this.beamLength; i += 1){
                app.image(sprite, app.getWizard().getX(), app.getWizard().getY() - 20*i);
            }
        }

        else if(this.direction == 1){
            for(int i = 0; i < this.beamLength; i += 1){
                app.image(sprite, app.getWizard().getX() + 20*i, app.getWizard().getY());
            }
        }
            ...
            for(int i = 0; i < this.beamLength; i += 1){
                app.image(sprite, app.getWizard().getX() + 20*i, app.getWizard().getY() - 20*i);
            }
        }
        return 0;
    }
