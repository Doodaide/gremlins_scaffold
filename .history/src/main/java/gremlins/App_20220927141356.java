...
public class App extends PApplet {
    ...
    */
    ...
    public boolean fireballHitGremlin(){
        for(Gremlin ig : gArray){
            if()
            if(i == existingFireballs.get(existingFireballs.size() - 1).getCollisionEntity()){
