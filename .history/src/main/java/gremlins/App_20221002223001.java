    ...
    public void gremlinRespawn(Gremlin g){
        ...
        while(!canRespawnX || !canRespawnY){
            if(!canRespawnX){
                ...
                else if((xTest >= wX + w.WIDTH+ 200 || xTest <= wX - 200)){ // too far left or right. Essentially both coords are valid. 
                    System.out.println("X: " + xTest + " Y: " + yTest);
                    canRespawnX = true;
                    canRespawnY = true;

                }
                else if(((xTest < wX + w.WIDTH + 200 && xTest > wX - 200) && ((yTest > wY + 200 + w.HEIGHT) || (yTest < wY - 200)))){
                    System.out.println("Alternate condition met" + " X: " + xTest + " Y: " + yTest);
                    canRespawnX = true;
                    canRespawnY = true;
                }
            ...
            if(!canRespawnY){
                ...
                else if((yTest < wY + w.HEIGHT + 200 && yTest > wY - 200) && (xTest > wX + w.WIDTH + 200 || xTest < wX - 200)){
                    System.out.println("Alternate condition met" + " X: " + xTest + " Y: " + yTest);
                    canRespawnX = true;
                    canRespawnY = true;
                }
