...
public class App extends PApplet {
    ...
    */
    public void setup() {
        ...
        try {
            ...
            this.portal = loadImage(URLDecoder.decode(this.getClass().getResource("Portal.png").getPath(), StandardCharsets.UTF_8.toString()));
        ...
        for (Character[] j : mapContents){
                ...
                for(Character k :j){
                    ...
                    if(k == 'X'){ // stone block
                        ...
                        mapToDraw.add(new ExitPortal(xCounter, yCounter, this.ExitPortal));
                    }
    ...
    */
    ...
    public void draw() {
        ...
        else if(passedLvl2 && passedLvl1){ // Win condition (pass lvl 2)
            background(219, 160, 9);
            textSize(40);
            fill(107, 9, 219);
