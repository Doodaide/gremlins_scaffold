...
public class App extends PApplet {
    ...
    /**
     * These are a set of hardset boundaries 
     */
    public final int leftBound = 20;
    public final int rightBound = 700;
    public final int upperBound = 20;
    public final int lowerBound = 660;
