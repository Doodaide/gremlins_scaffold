    ...
    */
    ...
    public void draw() {
        if(!instructionsUp){
            ...
            text("Touch the blue portal for a pretty cool experience", 20, 250);
            text("Be wary, frozen slime is harmless, frozen gremlins still hurt though", 90, 290); 
            text("More instructions are specified in the interface at the bottom", 120, 330);
            fill(0,0,0);
