...
public abstract class Mobile extends Entity{
    ...
    public int upCollision(App app){
        ...
        if(collides(this.getX(), this.getY(), app) || // top left corner, hit up
            collides(this.getX()+this.WIDTH, this.getY(), app)){ // top right cornder hit up 
            this.upAV = false;
            toReturn = 1;
            System.out.println("up 0");
        }
         
        else if(!collides(this.getX(), this.getY(), app) && 
            !collides(this.getX()+this.WIDTH, this.getY(), app)){ // top left corner, hit up
            this.upAV = true;
            toReturn = 0;
    ...
    public int rightCollision(App app){
        ...
        if(collides(this.getX()+this.WIDTH, this.getY(), app) || // Top right corner, hit right 
            collides(this.getX() + this.WIDTH, this.getY() + this.HEIGHT, app)){
            this.rightAV = false;
            toReturn = 1;
        ...
        else if(!collides(this.getX() +this.WIDTH, this.getY(), app) && // Top right corner, hit right 
            !collides(this.getX() + this.WIDTH, this.getY() + this.HEIGHT, app)){
            rightAV = true;
            toReturn = 0;
    ...
    public int leftCollision(App app){
        int toReturn = 0; // 0 = no collision. 1 = collision
        // ! Left side collision    
        if(collides(this.getX(), this.getY(), app)){ // top left corner
            if(collides(this.getX(), this.getY() + this.HEIGHT, app)){ // bottom left corner, hit left 
                this.leftAV = false;
                toReturn = 1;
            ...
            !collides(this.getX(), this.getY() + this.HEIGHT, app)){ // top left corner, hit left 
            this.leftAV = true;
            toReturn = 0;
    ...
    public int downCollision(App app){
        ...
        if(collides(this.getX(), this.getY() + this.HEIGHT, app)){// Bottom left corner, hit down
            if(collides(this.getX() + this.WIDTH, this.getY() + this.HEIGHT, app)){ // Bottom right corner, hit down
                this.downAV = false;
                toReturn = 1;
        ...
        else if(!collides(this.getX(), this.getY() + this.HEIGHT, app) && 
            !collides(this.getX() + this.WIDTH, this.getY() + this.HEIGHT, app)){// Bottom left corner, hit down
            this.downAV = true;
            toReturn = 0;
