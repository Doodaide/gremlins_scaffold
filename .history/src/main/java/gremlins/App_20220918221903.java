    ...
    */
    public void setup() {
        ...
        try {
            ...
            w = new Wizard(wizStartX, wizStaryY, 2, this.wizardSprites[0], this.wizardSprites[1], this.wizardSprites[2], this.wizardSprites[3], this.wizardSprites[4]);
