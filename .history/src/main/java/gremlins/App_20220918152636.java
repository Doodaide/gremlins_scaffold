...
public class App extends PApplet {
    ...
    */
    public void setup() {
        ...
        try {
            w = new Wizard(50, 50, 2, loadImage(URLDecoder.decode(this.getClass().getResource("wizard2.png").getPath(), StandardCharsets.UTF_8.toString())), // up imgRight, imgDown, imgLeft, projectile)
