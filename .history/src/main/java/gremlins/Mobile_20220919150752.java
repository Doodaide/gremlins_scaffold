...
public abstract class Mobile extends Entity{
    ...
    public int collision(App app) {
        ...
        if(collides(this.x - 1, this.y, app)// top left corner
            &&
            collides(this.x - 1, this.y+this.HEIGHT, app) // bottom left corner 
            ){
        ...
        if(collides(this.x , this.y+this.HEIGHT + 1, app) // bottom left corner 
            &&
            collides(this.x+this.WIDTH, this.y+this.HEIGHT + 1, app) // bottom right corner
            ){
        ...
        if(collides(this.x+this.WIDTH + 1, this.y, app)// Top right corner 
            &&
        ...
        if(!collides(this.x+this.WIDTH 
        = , this.y, app)// Top right corner 
            ||
            !collides(this.x+this.WIDTH, this.y+this.HEIGHT, app) // bottom right corner
            ){
        ...
        //* */ */ */       
        if (collides(this.x+this.WIDTH, this.y, app)// Top right corner 
            &&
            collides(this.x, this.y, app)// top left corner
            ){
