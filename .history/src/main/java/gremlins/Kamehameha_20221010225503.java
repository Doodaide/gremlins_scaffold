...
public class Kamehameha extends Projectile{
    ...
    public int draw(App app) {
        if(this.direction ==0 || this.direction == 2){ // up or down 
            for(int i = app.getWizard().getX() + 20; i < this.beamLength*20; i += )
        }

        else if (this.direction == 1 || this.direction 3){ // left or right 
