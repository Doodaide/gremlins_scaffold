...
public abstract class Mobile extends Entity{
    ...
    public int collision(App app) { // mob to block collision 
        ...
        if(collides(this.getX(), this.ygetY() + 2, app) || // top left corner 
        ...
        //System.out.println("upAV " + this.upAV);
        //System.out.println("rightAV " + this.rightAV);
        //System.out.println("downAV " + this.downAV);
        //System.out.println("leftAV " + this.leftAV);
