...
public class App extends PApplet {
    ...
    */
    ...
    /**
     * An organisational method that sections off part of the map updates fot he game
     * This includes drawing all of the blocks that are not assigned as null in the mapToDraw 
     */
