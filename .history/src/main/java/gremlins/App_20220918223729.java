    ...
    */
    public void setup() {
        ...
        try {
            ...
            this.brickwallDestruction[0] = loadImage(this.getClass().getResource("brickwall.png").getPath().replace("%20", " "));
            this.brickwallDestruction[1]
            this.brickwallDestruction[2]
