    ...
    */
    ...
    public void draw() {
        if(!instructionsUp){
            ...
            text("Use arrow keys to move the wizard, shoot fireballs with space", 80, 130); 
            text("Avoid the gremlins and slime at all costs", 140, 170); 
            text("Touch the pink portal to progress, Touch the blue portal for a pretty cool experience", 90, 210);
            text("Be wary, frozen slime is harmless, frozen gremlins still hurt though", 90, 250); 
            text("More instructions are specified in the interface at the bottom", 120, 290);
            fill(0,0,0);
