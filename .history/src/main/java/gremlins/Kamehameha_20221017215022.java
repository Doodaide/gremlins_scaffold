...
public class Kamehameha extends Projectile{
    ...
    public int tick(App app) {
        ...
        if(wDir == 0 && wX%20==0 && wY%20==0 && app.getWizard().getXVel() == 0){
            this.up();
            this.beamLength = (wY - app.upperBound)/20 + 2;
            ...
            this.right();
            this.beamLength = (app.rightBound - wX)/20 - 2;
            ...
            this.down();
            this.beamLength = (app.lowerBound - wY)/20 - 2;
            ...
            this.left();
            this.beamLength = (wX - app.leftBound)/20 + 2;
        ...
        if(this.alive){
            for(Immobile i : this.toDelete){
                if(i.getClass().getName().equals("gremlins.Destructable") ||i.getClass().getName().equals("gremlins.Indestructable")){
