...
public class App extends PApplet {
    ...
    */
    ...
    public int gremlinAI(int dir){
        ...
        if (x == 1) {
            gArray.get((int) (Math.random() * 4)).up();
        }

        else if(x == 2){
            gArray.get((int) (Math.random() * 4)).right();
        }

        else if (x == 3){
            gArray.get((int) (Math.random() * 4)).down();
        }

        else if(x == 4){
            gArray.get((int) (Math.random() * 4)).left();
        }
