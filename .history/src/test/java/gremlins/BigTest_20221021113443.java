...
public class BigTest {
    ...
    public void wizardImmobileInteractionTest(){
        ...
        int beforeCount = 0; // should end up at 21
        for (int i = app.getWizard().getX(); i < App.rightBound - app.getWizard().getX(); i+= 20) {
            for(Immobile I : app.getMap()){
                if(I != null){
                    if(I.getY() == app.getWizard().getY() && I.getX() > app.getWizard().getX() && I.getClass().getName().equals("f")){
                        beforeCount += 1;
                        break;
                    }
                }
        ...
        for (int i = app.getWizard().getX(); i < App.rightBound - app.getWizard().getX(); i+= 20) {
            for(Immobile I : app.getMap()){
                if(I != null){
                    if(I.getY() == app.getWizard().getY() && I.getX() > app.getWizard().getX()){
                        afterCount += 1;
                        break;
                    }
                }
