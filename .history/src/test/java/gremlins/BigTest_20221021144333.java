...
public class BigTest {
   ...
   @Test 
   public void wizardMobileInteractionTest(){
        /*
        ...
        while(app.getWizard().getExistingFireballs().get(0).collisionEntity == null){
            ...
            if(app.getWizard().getExistingFireballs().get(0).collisionEntity != null){
                app.noLoop(); 
                assertTrue( assertEquals("gremlins.Gremlin",app.getWizard().getExistingFireballs().get(0).collisionEntity.getClass().getName());)
                assertEquals("gremlins.Gremlin",app.getWizard().getExistingFireballs().get(0).collisionEntity.getClass().getName());
                break;
            }
            //System.out.println(counter + " " + app.getWizard().getExistingFireballs().get(0).collisionEntity);
        }
        app.noLoop(); 
