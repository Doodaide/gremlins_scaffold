...
public class AppTest {
    ...
    public void levelProgressionTest(){ 
        ...
        app.delay(500); 
        app.noLoop();
        // Now, the win screen should pop up. 
        // I will use the 'seconds' as an indication that 
        // Everything has been reset, as that is reset along with everything else 
        // in the same manner. Thus, if it were reset everything is reset 
