...
public class BigTest {
    ...
    public void gremlinAITest(){
        ...
        // Examine gremlin 0 in the gArray, identified with a square drawn under it
        Gremlin g = app.getGArray().get(0);
        
        app.rect(g.getX(), g.getY(), 20,20);
        app.fill(120,120,255);
        app.delay(5000);

        // If the gremlin hits a wall, does it go in a direction that is not the same direction. 
