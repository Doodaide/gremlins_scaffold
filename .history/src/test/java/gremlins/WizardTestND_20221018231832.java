...
public class WizardTestND {
    ...
    public void fireBallMethodTest(){
        ...
        w.setDirection(0); 
        w.shoot(); 
        assertEquals(0, w.getExistingFireballs().get(0).getDirection());

        assertEquals(2, w.getExistingFireballs().get(0).getDirection());

        assertEquals(3, w.getExistingFireballs().get(0).getDirection());
    ...
    public void ImmobileInteractionTest(){
        ...
        //assertNull(app.getWizard().getExistingFireballs().get(0));
