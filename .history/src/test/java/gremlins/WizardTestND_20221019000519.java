...
public class WizardTestND {
    ...
    public void ImmobileInteractionTest(){
        ...
        // With an index of -1, it means it is not in the arrayList anymore 
        assertEquals(-1, app.getMap().get(app.getMap().indexOf(f.collisionBlock)));
        app.getMap().contains(f.collisionBlock);
