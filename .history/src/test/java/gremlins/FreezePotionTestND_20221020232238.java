...
public class FreezePotionTestND {
    ...
    public void respawnMethodTest(){
        ...
        boolean statement1 = coords[0]+200 >= app.getWizard().getX() || coords[0]-200 <= app.getWizard().getX(); 
        boolean statement2 = coords[1]+200 >= app.getWizard().getY() || coords[1]-200 <= app.getWizard().getY();

        // This means the coordinates are sufficiently far away from the wizard
