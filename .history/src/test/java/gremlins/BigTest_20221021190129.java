...
public class BigTest {
   ...
   public void slimeHitWizardTest(){
        ...
        while(app.getWizard().getAlive()){
            System.out.println(app.getWizard().collisionEntity);
            if(app.getWizard().collisionEntity != null)
            if(app.getWizard().collisionEntity.getClass().getName().equals("gremlins.SlimeBall")){
                System.out.println("Detected slimeball collision");
            }
            app.redraw();
        }
        assertFalse(app.getWizard().getAlive());
