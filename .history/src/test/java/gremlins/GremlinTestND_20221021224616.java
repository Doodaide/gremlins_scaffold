...
public class GremlinTestND {
    ...
    public void shootSlimeBallTest(){
        ...
        assertEquals(3, g.getAvailableSlimeballs().get(g.getAvailableSlimeballs().size() - 1).getDirection());
        g.setDirection(1);
        g.shootSlimeBall(); 
        assertEquals(1, g.getAvailableSlimeballs().get(g.getAvailableSlimeballs().size() - 1).getDirection());
    }
}