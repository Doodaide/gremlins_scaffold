...
public class BigTest {
   ...
   public void directionalKamehamehaTest(){
        ...
        */
        ...
        Kamehameha k2= new Kamehameha(app.getWizard().getX(), app.getWizard().getY(), app.hBeam);
        ...
        */
        ...
        for (int i = app.getWizard().getY(); i < App.LOWERBOUND; i += 20) {
            for(Immobile I : app.getMap()){
                if(I != null){
                    if(I.getX() == app.getWizard().getX() && I.getX() < app.getWizard().getX() && I.getClass().getName().equals("gremlins.Destructable")){
                        downCount += 1;
                        break;
                    }
                }
        ...
        app.delay(1000);
        assertEquals(0, downCount); // check that it is equal to 1
